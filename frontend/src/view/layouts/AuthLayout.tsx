...
export function AuthLayout() {
    return(
        <div className="flex w-full h-full">
            ...
            <div className="w-1/2 h-ful justify-center items-center p-8 relative hidden lg:flex">
                <img
                    src={ilustration}
                ...
                <div className="max-w-[656px] bg-white bottom-8 mx-8 p-10 absolute rounded-b-[32px]">
